...
import com.example.springpractice.service.PostsUpdateRequestDto;
...
public class PostsApiControllerTest {
    ...
    @Test
    @WithMockUser(roles = "USER")   //테스트 시 권한이 필요하기 때문에 권한을 user로 변경
    public void Posts_등록된다() throws Exception{
        ...
        //when
        //spring 5.0 이후부터는 restTemplate 보다 WebClient를 권장한다.
